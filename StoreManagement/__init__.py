...
class ttkGUI:
    def __init__(self):
        ...
        ### login in text
        self.login_text = ttk.Label(
            master=self.frame2,
            text="Login",
            font=("Microsoft HaYei UI Bold", 25),
            anchor="center",
        )
        ...
        ### username
        self.username_text = ttk.Label(
            master=self.frame2, text="username", font=("Microsoft HaYei UI Light", 10)
        )
        self.username_text.place(x=50, y=130)
        self.username_entry = ttk.Entry(
            master=self.frame2,
            font=("Microsoft HaYei UI Light", 10),
            textvariable=self.username_var,
        )
        self.username_entry.place(x=120, y=130)

        ### password
        self.password_text = ttk.Label(
            master=self.frame2, text="password", font=("Microsoft HaYei UI Light", 10)
        )
        ...
        self.signin_button = ttk.Button(
            master=self.frame2, text="Sign in", command=self.signIn
        )
        self.signin_button.place(x=165, y=240)

        ### sign up
        self.signup_text = ttk.Label(
            master=self.frame2,
            text="Didn't have an account?",
            font=("Microsoft HaYei UI Light", 10),
        )
        self.signup_text.place(x=90, y=320)
        self.temp_signup_text = ttk.Label(
            master=self.frame2,
            text="Sign up",
            font=("Microsoft HaYei UI Light", 9),
            foreground="gray",
        )
        ...
        ### menu frame widgets
        self.displayItems_button = ttk.Button(
            master=self.menu_frame,
            text="Display Items",
            width=22,
            command=self.displayI_frame,
        )
        self.displayItems_button.place(x=0, y=10)
        self.addItems_button = ttk.Button(
            master=self.menu_frame, text="Add Items", width=22, command=self.addI_frame
        )
        self.addItems_button.place(x=0, y=50)
        self.removeItems_button = ttk.Button(
            master=self.menu_frame,
            text="Remove Items",
            width=22,
            command=self.removeI_frame,
        )
        self.removeItems_button.place(x=0, y=90)
        self.xItems_button = ttk.Button(
            master=self.menu_frame, text="X Items", width=22, command=self.xI_frame
        )
        self.xItems_button.place(x=0, y=130)
        self.yItems_button = ttk.Button(
            master=self.menu_frame, text="Log out", command=self.prevPage, width=22
        )
    ...
    def displayI_frame(self):
        self.displayItems_frame = ttk.Frame(
            master=self.home_frame, borderwidth=2, relief="solid"
        )
        self.displayItems_frame.place(x=170, y=45, width=620, height=400)
        self.text_label = ttk.Label(
            master=self.displayItems_frame,
            text="Items in Inventory",
            font=("Microsoft HaYei UI Bold", 20),
        )
        self.text_label.pack()

    def addI_frame(self):
        self.addItems_frame = ttk.Frame(
            master=self.home_frame, borderwidth=2, relief="solid"
        )
        self.addItems_frame.place(x=170, y=45, width=620, height=400)
        self.text_label2 = ttk.Label(
            master=self.addItems_frame,
            text="Add Items in Inventory",
            font=("Microsoft HaYei UI Bold", 20),
        )
        self.text_label2.pack()
        self.add_name_label = ttk.Label(
            master=self.addItems_frame,
            text="Name",
            font=("Microsoft HaYei UI Light", 10),
        )
        self.add_name_label.place(x=220, y=76)
        self.add_item_name_label = ttk.Label(
            master=self.addItems_frame,
            text="Item name",
            font=("Microsoft HaYei UI Light", 10),
        )
        self.add_item_name_label.place(x=200, y=136)
        self.add_quantity_label = ttk.Label(
            master=self.addItems_frame,
            text="Quantity",
            font=("Microsoft HaYei UI Light", 10),
        )
        ...
        self.name_entry = ttk.Entry(
            master=self.addItems_frame, textvariable=self.add_name_var
        )
        self.name_entry.place(x=275, y=75)
        self.item_name_entry = ttk.Entry(
            master=self.addItems_frame, textvariable=self.add_item_var
        )
        self.item_name_entry.place(x=275, y=135)
        self.quantity_entry = ttk.Entry(
            master=self.addItems_frame, textvariable=self.add_quantity_var
        )
        self.quantity_entry.place(x=275, y=196)
        self.add_item_button = ttk.Button(
            master=self.addItems_frame, text="Add Item", command=self.add_data, width=12
        )
    ...
    def add_data(self):
        self.db.insertData(
            ...
            self.add_item_var.get(),
            self.add_quantity_var.get(),
        )

    def removeI_frame(self):
        self.remove_frame = ttk.Frame(
            master=self.home_frame, borderwidth=2, relief="solid"
        )
        self.remove_frame.place(x=170, y=45, width=620, height=400)
        self.text_label3 = ttk.Label(
            master=self.remove_frame,
            text="Remove Items from Inventory",
            font=("Microsoft HaYei UI Bold", 20),
        )
        self.text_label3.pack()
        self.remove_name_label = ttk.Label(
            master=self.remove_frame, text="Name", font=("Microsoft HaYei UI Light", 10)
        )
        self.remove_name_label.place(x=220, y=76)
        self.remove_item_name_label = ttk.Label(
            master=self.remove_frame,
            text="Item name",
            font=("Microsoft HaYei UI Light", 10),
        )
        self.remove_item_name_label.place(x=200, y=136)
        self.remove_quantity_label = ttk.Label(
            master=self.remove_frame,
            text="Quantity",
            font=("Microsoft HaYei UI Light", 10),
        )
        ...
        self.remove_item_button = ttk.Button(
            master=self.remove_frame, text="Remove Item", command=self.add_data
        )
